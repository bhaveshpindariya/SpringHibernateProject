...
<html lang="en">
	...
	<div id="wrapper">
      ...
      <div id="page-wrapper"> 
      		 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Legal Manager Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="modal-dialog" >
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Edit legal manager detail</h4>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Add legal manager detail</h4>
      </div>
      <div class="modal-body">
        <form>
         <div class="form-group">
      		   ...
      		   <tbody>
          			<c:forEach items="${masters}" var="vlmanager" varStatus="status">     
 						<tr>
			            	...
			            	<td><c:out value="${vlmanager.eid}"/></td>
			            	<td><c:out value="${vlmanager.ename}"/></td>
			            	<td><c:out value="${vlmanager.vname}"/></td>
			            	<td><c:out value="${vlmanager.aname}"/></td>
...
function synchronize(){
	...
	$.ajax({
	    type: "Get",
	    url: "synchronizeExcelLegalApprovers",
	    success: function(data){
	    	if(data.success==true){
	    		$('#loading').modal('hide');
	    		$("#exampleModalLabelTitle1").html("Successfully");
