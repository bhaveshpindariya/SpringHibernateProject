...
<html lang="en">
	...
	<div id="wrapper">
      ...
      <div id="page-wrapper"> 
      		 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cost Center Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                    	<div class="panel-heading headingp">
                             <button type="button" class="btn btn-info btnright" onclick="valides()" id="synchronize">Synchronize</button>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size:13px;">
							       ...
							       <tbody>
							            <c:forEach items="${master}" var="cost" varStatus="status">     
							  				<tr>
							            		<td><c:out value="${cost.cCode}"/></td>
							                	<td><c:out value="${cost.cName}"/></td>
							                	<td><c:out value="${cost.companyName}"/></td>
							            	</tr>   
										</c:forEach>
							      </tbody>
                                </table>
		...
		$.ajax(
		  {
	        ...
	        success: function (item) 
	        {
	        	...
	        	{
	           		ss=true;
	           		table1.fnAddData([item[i].cCode,item[i].cName,item[i].companyName]);            
	        	}
	        },
