                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size:13px;">
							       ...
							       <tbody>
							            <c:forEach items="${master}" var="branch" varStatus="status">     
							  				<tr>
							            		<td><c:out value="${branch.ebCode}"/></td>
							                	<td><c:out value="${branch.ebName}"/></td>
							                	<td><c:out value="${branch.companyName}"/></td>
							            	</tr>   
										</c:forEach>
							      </tbody>
                                </table>
		...
		$.ajax(
		  {
	        ...
	        success: function (item) 
	        {
	        	...
	        	{
	           		ss=true;
	           		table1.fnAddData([item[i].ebCode,item[i].ebName,item[i].companyName]);             
	        	}
	        },
