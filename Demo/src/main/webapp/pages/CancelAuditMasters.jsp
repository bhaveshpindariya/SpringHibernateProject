...
<html lang="en">
	...
	<div id="wrapper">
      ...
      <div id="page-wrapper"> 
      		 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cancel Audit Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
							        ...
							        <tbody>
							            <c:forEach items="${master}" var="print" varStatus="status">     
							  			<tr>
							                ...
							                <td><c:out value="${print.creason}"/></td>
							                <td><c:out value="${print.date}"/></td>
							                <td><c:out value="${print.docno}"/></td>
							                <td><c:out value="${print.documenttitle}"/></td>
							                <td><c:out value="${print.caseId}"/></td>
							                <td><c:out value="${print.taskName}"/></td>
